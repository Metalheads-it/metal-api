...
const validateRequestData = (method: HttpMethod, data: Data, compiledSchemas: CompiledSchema) => {
    const schemaMap = {
...
export const createEndpointClient = <T extends EndpointSchema>(schema: T) => {
    const compiledSchemas = {
        querystring: schema.querystring ? ajv.compile(schema.querystring) : undefined,
